<script setup>
/**
 * StatSlide — Two or three stats in the rail, big takeaway wall on the right.
 * Used for the Einstieg slide (Strom / Wasser / CO₂ resource consumption).
...
.rail {
  ...
  gap: 1.25rem;
  border-left: 3px solid var(--rail-bg);
}
.kicker {
  font-size: 0.7rem;
