<script setup>
/**
 * ExampleSlide — Sober example + discussion question, paired with a SCOPE Frame slide.
 * Rail (SCOPE color) on the left. Body on the right with a factual note, an optional
 * stat block with source, and one discussion question. No personas, no slogans.
 * Props: letter, name, position, color, note?, stat?, statLabel?, statSource?, discussion.
 * Legacy props slogan?/brand? are still accepted but should stay empty.
